    ...
    <div class="index-container">
        ...
        <div class="top-title-wrapper">
            <div class="header-top-title">
                <h2 class="header-top-title-text">Tady najdete užitečné výpočetní aplikaci pro rychlé a přehledné vyúčtování mezi pronajímatelem a nájemníkem</h2>
            </div>
            <button type="button" class="header-top-button">
            <a href="/applications">Přejit do aplikací</a>
            </button>
        </div>
        ...
        <div class="main-phrases">
            <div class="text-block-1">
                <div class="text-block">
                    <ul>
                        ...
                        <li>Potřebujete správně vyúčtovat nájemníkovi služby, spojené s užíváním bytu? </li>
                        <li>Potřebujete zpracovat přehledné vyúčtování spotřeby elektřiny, plynu, vodného nebo stočného?</li>
                    </ul>
                </div>

                <div class="picture-block left-block">
            ...
            <div class="text-block-2">
                <div class="text-block">
                    <ul>
                        <li>Jste nájemník?</li>
                        <li>Potřebujete zkontrolovat vyúčtování pronajímatele? </li>
                        <li>Potřebujete ověřit, jestli pronájmatel správně vyúčtoval zálohy za služby nebo další energií? </li>
                    </ul>
                </div>


                <div class="picture-block right-block">
                </div>
            </div>
        </div>
        ...
        <div class="features">
            <div class="feature first-feature"><span>Intuitivné rozhrání</span></div>
        ...
        <div class="final-thesis">
            <div class="list-of-thesis">
                <div class="list-of-thesis-row-1">
                    <ul>
                        <li>Aplikace, představené na těchto stránkách, Vám pomůžou jednoduché a rychle přefakturovat poměrnou část nákladů na služby a energii na základě skuteční spotřeby a skutečné dekly pronájmu.</li>
                        <li>Vyúčtování se da zpracovat za kteroukoliv období</li>
                        <li>Souhrnné vyúčtování</li>
                        <li>Přehledné vyúčtování kauce složené pronajímatelem</li>
                        <li>Aplikace jsou přizpůsobené pro veškerá mobilní zařízení. Možnost provést vyúčtování při převzetí nemovitosti od nájemníků přímo z mobilu nebo tabletu.</li>
                    </ul>
